...
# SSH Configuration
ssh_key_name      = "3-tier-architecture" # REQUIRED: Replace with your key pair name
allowed_ssh_cidrs = ["0.0.0.0/0"]        # CHANGE THIS: Use your IP address like "1.2.3.4/32"
...
frontend_docker_image = "kanha05/goal-tracker-frontend:latest"
backend_docker_image  = "kanha05/goal-tracker-backend:latest"
